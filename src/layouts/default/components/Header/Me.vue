<template>
  ...
  <el-dialog :title="$t('layout.header.lockScreen')" v-model="visible" width="30%">
    <div class="lock-dialog">
      ...
      <el-form ref="formRef" :model="formData" :rules="rules" class="lock-form" label-position="top">
        <el-form-item :label="$t('layout.header.lockPassword')" prop="lockPassWord">
          <el-input
        ...
        <el-form-item>
          <el-button type="primary" style="width: 100%" @click="handleLock">{{ $t('layout.header.lock') }}</el-button>
        </el-form-item>
      </el-form>
    </div>
  </el-dialog>
