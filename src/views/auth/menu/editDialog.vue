  ...
  >
    <el-form ref="formRef" :model="formData" :rules="rules" label-width="100px">
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item :label="formData.type == 2 ? '按钮名称：' : '名称：'" prop="name">
            <el-input v-model="formData.name" :placeholder="formData.type == 2 ? '请输入按钮名称' : '请输入名称'" />
          </el-form-item>
        </el-col>

        <el-col :span="24">
          <el-form-item label="菜单图标：" v-if="formData.type != 2" prop="icon">
        ...
        <el-col :span="24">
          <el-form-item label="上级目录：" prop="parentId" v-if="formData.type != 0">
    ...
    <template #footer>
      <span class="dialog-footer">
        ...
        <el-button type="primary" @click="handleDetermine(formRef)">确 定</el-button>
      </span>
    </template>
  </el-dialog>
</template>
