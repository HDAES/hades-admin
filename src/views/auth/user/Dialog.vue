<template>
  <el-dialog v-model="dialogConfig.visible" :title="dialogConfig.type == 'edit' ? '编辑' : '新增'" width="600px">
    <el-form label-width="80px" ref="ruleFormRef" :model="formData" :rules="rules">
      <el-row>
